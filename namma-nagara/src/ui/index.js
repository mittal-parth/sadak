...
export class UiSystem {
  ...
  async init(ctx) {
    ...
    // Open-world levels swap the combat furniture for a district card. The
    // market street constructs nothing and is untouched.
    this.city = ctx.config.level === 'bengaluru' ? new CityHud(ctx, this) : null;
