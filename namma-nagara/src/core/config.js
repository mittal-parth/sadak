...
export const DEFAULTS = {
  quality: 'ultra',
  /**
   * Which level `world` builds. See `src/world/levels/index.js` for the registry.
   * `market` is the default because it is the reference level the pixel gate
   * (tools/baseline.mjs + tools/imagediff.mjs) is calibrated against.
   */
  level: 'market',
